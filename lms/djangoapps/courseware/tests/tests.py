...
from courseware.tests.modulestore_config import TEST_DATA_XML_MODULESTORE as XML_MODULESTORE
from courseware.tests.modulestore_config import TEST_DATA_MIXED_TOY_MODULESTORE as TOY_MODULESTORE
