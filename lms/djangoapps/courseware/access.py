...
def _get_merged_group_access(block):
    """
    """
    ...
    merged_access = {}
    blocks_to_root = path_to_root(modulestore(), block.location)
...
def _has_access_descriptor(user, action, descriptor, course_key=None):
    ...
    def can_load():
        ...
        merged_access = _get_merged_group_access(descriptor)
        print merged_access
        ...
        print merged_access, partition_groups
